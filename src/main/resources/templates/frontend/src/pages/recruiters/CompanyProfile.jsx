...
const CompanyProfile = () => {
    ...
    if (loading) return <div className="company-profile-container" style={{textAlign:'center', padding:'50px'}}>Đang tải...</div>;
            ...
            <form onSubmit={handleSubmit} className="form-grid">
                ...
                <div className="full-width">
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', marginTop: '30px' }}>
                        <button type="submit" className="btn-save-company">
                            Lưu Thông Tin
                        </button>
